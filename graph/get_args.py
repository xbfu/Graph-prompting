...
def get_args():
    ...
    parser.add_argument('--dataset_name', type=str, default='ENZYMES', help='Choose the dataset')
    parser.add_argument('--device', type=int, default=3, help='Which gpu to use if any (default: 0)')
    parser.add_argument('--gnn_type', type=str, default="GIN", help='GCN or GIN')
    ...
    parser.add_argument('--num_layer', type=int, default=5, help='Number of GNN message passing layers (default: 2).')
